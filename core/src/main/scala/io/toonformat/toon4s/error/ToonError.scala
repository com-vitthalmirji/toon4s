...
object DecodeError {
  ...
  /** Value out of allowed range.
    *
    * Includes: array length mismatch, exceeded depth limits, exceeded size limits, count
    * mismatches.
    *
    * @param message
    *   Error description
  ...
  /** Unexpected error during decoding.
    *
    * Catch-all for errors that don't fit other categories (e.g., I/O errors, unexpected
    * exceptions).
    *
    * @param message
    *   Error description
